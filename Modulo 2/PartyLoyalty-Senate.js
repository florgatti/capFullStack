...
var h = members.results[0].members
...
grdData(members.results[0].members);

leastEngData(members.results[0].members);
...
function membersData(members){
  ...
  porcIndependent = Math.round(porcIndependent/repsIndependent);
